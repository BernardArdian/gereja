      ...
      <main className="max-w-5xl mx-auto">
        ...
        <header className="py-4 border-b border-amber-500 mb-4">
          ...
          <p className="text-[12px] font-medium tracking-[0.18em] uppercase text-gray-800 mb-1">
            Arsip Katekse Orang kudus, Devosi, Renugan dan Tradisi Gereja
          </p>
        </header>

        {/* TABS */}
        <nav
          className="flex justify-center items-center gap-0  mb-10 overflow-hidden"
          onWheel={(e) => e.preventDefault()}
        >
          {["orang kudus", "renungan", "devosi", "tradisi gereja"].map((t) => (
            <button
              key={t}
        ...
        {/* CONTENT */}
        <section className="min-h-[400px]">{renderContent()}</section>
      </main>
    </section>
  );
}
